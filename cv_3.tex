...
\begin{minipage}[t]{0.585\textwidth} % Start the left-hand side of the page
...
\begin{itemize}\itemsep-0.25em \item Part of research team that developed and implemented an algorithm to simulate CNC Machining using Octree and Quadtree data structures \item First professional experience, learnt how to manage and work on a large scale project \item Sped up existing algorithm by 12.5\%.
\end{itemize	}\\
...
Jul 2014 & \textbf{B.E.} \\ 
& \textsc{Computer Science} \\ 
& \textit{M. S. Ramaiah Institute of} \\
& \textit{Technology, INDIA} \\
& \small Cum GPA. : 9.02 \\
&\\
\end{tabular}\\[10pt]
