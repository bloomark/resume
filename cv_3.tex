...
{\raggedright\large Amazon.com \normalsize\textsc{ | Seattle, WA \& Sydney, NSW} | 10/01/2025 - Current\\
\textbf{Principal Software Engineer | Builders Foundations}\\[2pt]}
\begin{itemize}\itemsep-0.5em
    \item Improved time to release new features to customers by 74pct for the average Amazon team, 71pct for p90.
    \item In December 2025, I moved to work on systems at the heart of the 'store' (Amazon.com) to evolve their testing practices to be AI-native - i.e. bring
        local testing to the masses, so their coding harnesses can have verifiable end states and use /goal
\end{itemize}
