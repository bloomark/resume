...
\usepackage{hyperref}
\definecolor{linkcolor}{HTML}{2b2b2b} % Blue-gray color for links
\definecolor{shade}{HTML}{e5e4e2} % Peach color for the contact information box
\definecolor{text1}{HTML}{2b2b2b} % Main document font color, off-black
\definecolor{headings}{HTML}{6A6A6A} % Dark red color for headings
